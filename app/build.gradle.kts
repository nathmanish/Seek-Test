...
dependencies {
    ...
    testImplementationCoreTesting()
    testImplementationCoroutineTesting()
    testImplementationMockitoCore()
    testImplementationMockitoInline()
    testImplementationMockitoKotlin()
